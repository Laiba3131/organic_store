...
class TrendingCategoriesSeeAll extends StatefulWidget {
  const TrendingCategoriesSeeAll({super.key});

  @override
  State<TrendingCategoriesSeeAll> createState() => _TrendingCategoriesSeeAllState();
}

class _TrendingCategoriesSeeAllState extends State<TrendingCategoriesSeeAll> {
  late String userId;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: AppText(text: 'Trending Categories', fontSize: 20, textColor: Colors.white),
        centerTitle: true,
      ),
