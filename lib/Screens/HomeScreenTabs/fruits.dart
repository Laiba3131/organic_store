...
class FruitsFilter extends StatefulWidget {
  const FruitsFilter({super.key});

  @override
  State<FruitsFilter> createState() => _FruitsFilterState();
}

class _FruitsFilterState extends State<FruitsFilter> {
